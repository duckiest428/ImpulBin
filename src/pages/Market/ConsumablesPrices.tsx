                            ...
                            {mockConsumables.map((c, i) => (
                                <tr key={i} className="border-b border-[#2d2d2d] hover:bg-[#252525] transition-colors">
                                    ...
                                    <td className="p-4 text-gray-300">
                                        {c.price} <SafeImage src={'https://cdn.futbin.com/design/img/coins_bin.png'} fallbackType="coin" className="w-3.5 h-3.5 inline ml-1" alt="coins" />
                                    </td>
                                    <td className="p-4 text-gray-300">
                                        {c.min} <SafeImage src={'https://cdn.futbin.com/design/img/coins_bin.png'} fallbackType="coin" className="w-3.5 h-3.5 inline ml-1" alt="coins" />
                                    </td>
                                    <td className="p-4 text-gray-300">
                                        {c.max} <SafeImage src={'https://cdn.futbin.com/design/img/coins_bin.png'} fallbackType="coin" className="w-3.5 h-3.5 inline ml-1" alt="coins" />
                                    </td>
                                    <td className="p-4">
