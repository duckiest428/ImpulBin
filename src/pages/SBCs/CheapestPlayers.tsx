        ...
        <div className="w-full min-h-screen bg-[#1a1a1a] text-white pt-24 px-4 pb-16">
            <div className="max-w-7xl mx-auto flex flex-col gap-6">
                ...
                <div>
                    ...
                    <h1 className="text-2xl font-bold text-white mb-1 flex items-center gap-2"><img src={`${import.meta.env.BASE_URL}assets/icons/main-sbcs.svg`} className="w-[28px] h-[28px]" alt="SBCs" />FIFA 17 Cheapest Players</h1>
                                    ...
                                    <div key={player.id} className="flex items-center justify-between p-2 border-b border-[#2d2d2d] hover:bg-[#252525] transition-colors last:border-0">
                                        <div className="flex items-center gap-3 overflow-hidden">
                                            <PlayerHoverWrapper position="CB">
                                                <div className="w-[32px] shrink-0 [@container]">
                                                    <FIFA17PlayerCardBase name={player.name} rating={rating} position={player.pos} />
                                                </div>
                                            </PlayerHoverWrapper>
