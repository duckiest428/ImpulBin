        ...
        <div className="w-full min-h-screen bg-[#1a1a1a] text-white pt-24 px-4 pb-16">
            <div className="max-w-7xl mx-auto flex flex-col gap-6">
                ...
                <div>
                    ...
                    <h1 className="text-2xl font-bold text-white mb-1 flex items-center gap-2"><img src={getAssetUrl('assets/icons/main-sbcs.svg')} className="w-[28px] h-[28px]" alt="SBCs" />FIFA 17 Cheapest Players</h1>
