                ...
                <header className="w-full flex flex-col items-center justify-center mb-8 md:mb-12">
                    ...
                    <div className="w-full max-w-2xl mx-auto flex items-center bg-[#1a1a1a] border border-[#383838] focus-within:border-[#00e575] rounded-full px-6 py-3.5 shadow-2xl transition-all">
                        ...
                        <input 
                            ...
                            className="w-full bg-transparent border-none text-white outline-none text-base placeholder-gray-500"
                        />
                        <select className="bg-transparent border-none text-gray-300 text-sm outline-none cursor-pointer pl-3 border-l border-gray-700 font-semibold">
