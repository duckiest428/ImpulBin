                    ...
                    <table className="w-full text-left border-collapse whitespace-nowrap text-sm">
                        <thead>
                            <tr className="bg-black/50 border-b border-gray-800 text-xs font-bold text-gray-400 uppercase">
                                ...
                                <th className="p-4">Rat</th>
                                <th className="p-4">Pos</th>
                                <th className="p-4">Price</th>
                                <th className="p-4">FUTBIN Rating</th>
                                <th className="p-4">Foot</th>
                                <th className="p-4">SM</th>
                                <th className="p-4">WF</th>
                                ...
                                <th className="p-4">POP</th>
                                <th className="p-4">IGS</th>
                            ...
                            {mockPlayers.map(player => (
                                <tr key={player.id} className="hover:bg-gray-800/50 transition-colors group">
                                    ...
                                    <td className="p-4 text-center">
                                        <button className="text-gray-500 hover:text-green-500 bg-gray-800 p-2 rounded">👁</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
